# -*- coding: utf-8 -*-
"""
eqidv4_eod_scheduler_for_1540_update.py
========================================

Runs once per trading day at 15:40 IST to perform a final flush of
EQIDV4 intraday parquet data (15-minute and 5-minute) with all of
...
Since the eqidv4 core only supports intraday modes (5min, 15min), this
...
# =============================================================================
# Wire eqidv4 core into sys.path
# =============================================================================
...
REPORT_DIR = _ROOT / "reports" / "eqidv4_reports"
...
def main() -> None:
    ...
    print("[EOD] EQIDV4 1540 scheduler started.")
