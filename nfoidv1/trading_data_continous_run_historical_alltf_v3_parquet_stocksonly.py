...
What remains:
- NSE F&O universe loader (filtered_stocks_NSE_FO_only.py or stocks_tickers.txt)
...
def load_stocks_universe(logger: logging.Logger) -> tuple[list[str], dict[str, int]]:
    """
    Universe loader (NSE F&O-ready):
    - Preferred: filtered_stocks_NSE_FO_only.py with either:
    ...
    raise RuntimeError(
        ...
        "Fix options:\n"
        "  1) Ensure filtered_stocks_NSE_FO_only.py is importable and define either:\n"
