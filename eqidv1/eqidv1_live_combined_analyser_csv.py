...
def _write_signals_csv(signals_df: pd.DataFrame, *, strategy: str = "eqidv1") -> int:
    """
    ...
    with open(csv_path, "a", newline="", encoding="utf-8") as f:
        ...
        if signals_df is not None and (not signals_df.empty):
            for _, row in signals_df.iterrows():
                ...
                # eqidv1 scanner is rule-based; ML fields are neutral
                p_win = 1.0
                ml_thr = 0.0
                conf_mult = 1.0
                ...
                notes = f"eqidv1|setup={setup}|impulse={impulse}"
...
def _scan_latest_slot(
    *,
    ...
    written = _write_signals_csv(signals_df, strategy="eqidv1")
...
def main() -> None:
    ...
    print(f"[START] eqidv1 live (avwap_live style) | data_dir={DIR_15M} | out={LIVE_SIGNAL_DIR}", flush=True)
