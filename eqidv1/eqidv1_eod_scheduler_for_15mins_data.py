...
Run:
    python eqidv1_eod_scheduler_for_15mins_data.py

Optional:
    python eqidv1_eod_scheduler_for_15mins_data.py --buffer-sec 75 --max-workers 24
"""
...
# ---------------------------------------------------------------------
# Locate eqidv1 folder (robust even if your repo is nested oddly)
# ---------------------------------------------------------------------
...
core.setup_kite_session = setup_kite_session_from_eqidv1_dir
