# -*- coding: utf-8 -*-
"""
eqidv1_live_combined_analyser_parquet.py
========================================

Live parquet variant aligned with `eqidv1_live_combined_analyser_csv.py`:
...
def main() -> None:
    ...
    print("[LIVE] EQIDV1 PARQUET v2 (15m) | strict current 15m slot only")
    ...
    while True:
        ...
        if live.UPDATE_15M_BEFORE_CHECK:
            try:
                print(f"[UPD ] Running eqidv1 core 15m update at {live.now_ist().strftime('%Y-%m-%d %H:%M:%S%z')}")
