# -*- coding: utf-8 -*-
"""
Created on Fri Jan 31 10:26:24 2025
...
EXECUTED_SIGNALS_FILE = "executed_signals_cover_limit.json"
...
def execute_paper_trades(last_trading_day, kite, api_semaphore, paper_trade=True):
    ...
    for index, row in new_trades_df.iterrows():
        try:
            ...
            order_type = kite.ORDER_TYPE_LIMIT  # For Cover Orders, use LIMIT or MARKET
            ...
            if paper_trade:
                ...
                logging.info(
                    f"[SIMULATION] Placed Cover {transaction_type} order for {ticker} at {price} with SL at {stop_loss_price}. "
                ...
                with api_semaphore:
                    try:
                        # 1. Place Cover Order (Limit Entry + SL)
                        cover_order_id = kite.place_order(
                            ...
                            price=price,               # Limit price from CSV
                        ...
                        logging.info(
                            f"Placed Cover {transaction_type} order for {ticker} at {price} with SL at {stop_loss_price}. "
                        ...
                        logging.info(
                            f"Placed Target {target_transaction_type} order for {ticker} at {target_price}. "
