...
def execute_paper_trades(last_trading_day, kite, api_semaphore, paper_trade=True):
    ...
    for index, row in new_trades_df.iterrows():
        try:
            ...
            order_type = kite.ORDER_TYPE_MARKET  # MARKET Order for Cover
            validity = kite.VALIDITY_DAY
            variety = kite.VARIETY_COVER
            tag = 'CoverOrder'
            ...
            if paper_trade:
                ...
                with api_semaphore:
                    try:
                        ...
                        logging.info(f"Cover order {cover_order_id} for {ticker} has been filled.")
                        print(f"Cover order {cover_order_id} for {ticker} has been filled.")
                        ...
                        while not oco_completed:
                            ...
                            if target_filled:
                                ...
                                try:
                                    kite.cancel_order(order_id=cover_order_id, variety=kite.VARIETY_COVER)
                                ...
                                try:
                                    kite.cancel_order(order_id=target_order_id, variety=kite.VARIETY_REGULAR)
