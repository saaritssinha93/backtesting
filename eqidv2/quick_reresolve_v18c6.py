# -*- coding: utf-8 -*-
"""Quick exit re-resolve for v18c6. Run: python quick_reresolve_v18c6.py

Optional target override (e.g. test 0.60% target on both sides):
    python quick_reresolve_v18c6.py --short-tgt 0.006 --long-tgt 0.006
"""
import sys
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Quick exit re-resolve for v18c6")
