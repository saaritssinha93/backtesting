...
Usage:
    python avwap_trade_execution_PAPER_TRADE_TRUE_v5.py
    python avwap_trade_execution_PAPER_TRADE_TRUE_v5.py --no-ltp
    python avwap_trade_execution_PAPER_TRADE_TRUE_v5.py --capital 500000
"""
...
PAPER_TRADE_LOG_PATTERN = "paper_trades_{}_v5.csv"
PAPER_TRADE_EXEC_LOG_PATTERN = "paper_trade_execution_{}_v5.log"
...
def _restore_intraday_runtime_state(
    ...
    # Build today's signal lookup by signal_id from both v5_short + v5_long CSVs
