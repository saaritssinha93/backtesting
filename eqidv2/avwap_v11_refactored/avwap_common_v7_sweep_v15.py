# -*- coding: utf-8 -*-
"""
v15 wrapper around avwap_common_v7_sweep.

Keeps shared v7 sweep code unchanged while tightening only the market-regime
source selection used by avwap_combined_runner_v15.
"""
...
def build_market_regime_map(cfg: StrategyConfig) -> Tuple[Dict[str, int], str]:
    ...
    v15 is more defensive than v14 here:
