# -*- coding: utf-8 -*-
"""
Runner-level regime fix wrapper around avwap_common_v11.

Keeps shared v11 code unchanged while exposing a safer market-regime builder
for combined runners that would otherwise pick an all-neutral index feed.
"""
