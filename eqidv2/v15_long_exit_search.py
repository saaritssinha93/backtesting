...
from v15_sltarget_search import (
...
OUT_DIR = ROOT / "outputs_v15_long_exit_search"
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Focused v15 long-exit search")
