# B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK (LONG) — REDESIGNED_SETUP_IDEAS

_Generated 2026-07-03. From-scratch recovery loop. Research-only; NO live trades; NO final_setup_conf.py edits._

Setup intent: huge green bar, pullback holds the body, close-near-high break -> continuation of institutional impulse.
