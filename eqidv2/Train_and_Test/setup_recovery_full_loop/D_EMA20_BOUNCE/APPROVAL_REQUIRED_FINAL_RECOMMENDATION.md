...
- Baseline TRAIN: n=810 PF=0.5029 net=-186044.56
- Baseline TEST: n=296 PF=0.5242 net=-60440.79
- Best/selected TRAIN: not run
- Best/selected TEST: not run
- TEST PF crossed 1.40: False
- Candidate config path: `C:\Users\Saarit\OneDrive\Desktop\Trading\backtesting\eqidv2\backtesting\eqidv2\Train_and_Test\setup_recovery_full_loop\D_EMA20_BOUNCE\candidates\final_candidate_needing_approval.json`
- Final config needing approval: `C:\Users\Saarit\OneDrive\Desktop\Trading\backtesting\eqidv2\backtesting\eqidv2\Train_and_Test\setup_recovery_full_loop\D_EMA20_BOUNCE\candidates\final_candidate_needing_approval.json`
...
```powershell
python Train_and_Test\setup_recovery_full_loop\_shared\scripts\recover_d_setups.py --setups D_EMA20_BOUNCE --iterations 75 --scan-workers 1 --slippage-bps 5.0
```
