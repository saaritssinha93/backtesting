r"""run_baseline.py — Stage 1: baseline evaluation for C_SHORT_CONTINUATION_BREAK (research-only).

No config of record exists (never promoted; production collapse gives it zero rows).
Baselines = raw pre-collapse detector at three representative exits.
"""
