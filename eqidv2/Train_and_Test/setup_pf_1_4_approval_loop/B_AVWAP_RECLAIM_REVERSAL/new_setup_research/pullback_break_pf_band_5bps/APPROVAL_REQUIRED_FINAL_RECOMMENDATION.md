# APPROVAL_REQUIRED — FINAL RECOMMENDATION — B_AVWAP_RECLAIM_PULLBACK_BREAK_LONG (LONG)
...
```
# baseline replay:
py -3.12 Train_and_Test/setup_loop_runner.py --setup B_AVWAP_RECLAIM_PULLBACK_BREAK_LONG --pool Train_and_Test\setup_pf_1_4_approval_loop\B_AVWAP_RECLAIM_REVERSAL\new_setup_research\family_pool --configs <baseline.json> --train_start 2026-05-18 --train_end <day-before-test> --test_start 2026-06-20 --test_end <latest> --slippage_bps 5.0
