...
def write_baseline_md(path, setup, side, baseline, sess, base_tr15, base_te15, base_tr5, base_te5, search_bps=15.0):
    L = [f"# BASELINE_RESULT — {setup} ({side})", "",
         ...
         f"| window | {search_bps:.0f} bps/leg (search basis) | 5 bps/leg (paper) |", "|---|---|---|",
...
def main() -> int:
    ...
    write_baseline_md(outdir / "BASELINE_RESULT.md", setup, args.side, baseline, sess,
                      base_tr15, base_te15, base_tr5, base_te5, search_bps=args.slippage_bps)
