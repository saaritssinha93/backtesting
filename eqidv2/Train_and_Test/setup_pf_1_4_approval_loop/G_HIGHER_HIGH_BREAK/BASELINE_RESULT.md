...
- Baseline TRAIN PF inf / TEST PF 0.0 (target: TRAIN in [1.30,1.70], TEST > 1.40).
- TEST sample is 11 trades over 3 day(s) — thin June data is the binding constraint on OOS confidence.