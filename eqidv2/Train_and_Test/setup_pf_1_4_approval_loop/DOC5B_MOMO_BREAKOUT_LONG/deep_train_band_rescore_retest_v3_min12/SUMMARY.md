...
TEST was evaluated only for configs whose full TRAIN PF remained inside 1.30-1.70 with at least 12 trades.
...
- TRAIN PF 1.303 over 12 trades, net Rs1,103.
- TEST PF 0.0 over 4 trades, net Rs-4,364.
- Config: `{"daily_loss_rs": 0.0, "entry_guards": {"max_slot": "12:30", "min_slot": "10:00"}, "exit": {"sl_pct": 1.0, "tgt_pct": 0.8}, "mask_terms": [["retest_depth_atr", ">=", 0.350946]], "max_positions": 20, "pre_momentum_terms": [["sig5_adx_calc", ">=", 25.422361]], "side": "LONG"}`
