...
| day-block p | 1.0 |
| top day | 2026-06-02 00:00:00: Rs7,853 |
...
| top-symbol net share | 9.99 |
| day-block p | 0.9446 |
| top day | 2026-06-12 00:00:00: Rs15,943 |
| top symbol | JAICORPLTD: Rs1,266 |

## Initial diagnosis

- Baseline TRAIN PF 0.287 / TEST PF 0.463 (target: TRAIN PF >= 1.30, TEST PF >= 1.40 with day-block p <= 0.10).
- TEST sample is 2 trades over 1 day(s) — thin June data is the binding constraint on OOS confidence.