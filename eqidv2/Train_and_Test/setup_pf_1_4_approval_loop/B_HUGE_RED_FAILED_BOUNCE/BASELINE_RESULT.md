...
| SL / TGT / EOD exits | 3 / 4 / 10 |
| trades/day | 1.31 |
| days / symbols | 13 / 17 |
| top-trade gross share | 0.17 |
| top-day net share | 14.266 |
| top-symbol net share | 14.266 |
| day-block p | 0.4924 |
| top day | 2026-06-08: Rs1,018 |
...
| day-block p | 1.0 |
| top day | 2026-06-15: Rs-101 |
| top symbol | JYOTHYLAB: Rs-101 |

## Initial diagnosis

- Baseline TRAIN PF 1.012 / TEST PF 0.0 (target: TRAIN in [1.30,1.70], TEST > 1.40).
- TEST sample is 42 trades over 5 day(s) — thin June data is the binding constraint on OOS confidence.