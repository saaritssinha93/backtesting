...
| top-symbol net share | 9.99 |
| day-block p | 0.9552 |
| top day | 2026-06-15: Rs342 |
| top symbol | SONACOMS: Rs768 |

## Initial diagnosis

- Baseline TRAIN PF 0.738 / TEST PF 0.532 (target: TRAIN in [1.30,1.70], TEST > 1.40).
- TEST sample is 13 trades over 5 day(s) — thin June data is the binding constraint on OOS confidence.