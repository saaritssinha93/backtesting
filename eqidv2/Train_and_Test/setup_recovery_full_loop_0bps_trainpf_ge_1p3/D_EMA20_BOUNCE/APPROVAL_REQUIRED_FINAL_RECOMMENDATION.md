...
- Candidate config path: `C:\Users\Saarit\OneDrive\Desktop\Trading\backtesting\eqidv2\backtesting\eqidv2\Train_and_Test\setup_recovery_full_loop_0bps_trainpf_ge_1p3\D_EMA20_BOUNCE\candidates\final_candidate_needing_approval.json`
- Final config needing approval: `C:\Users\Saarit\OneDrive\Desktop\Trading\backtesting\eqidv2\backtesting\eqidv2\Train_and_Test\setup_recovery_full_loop_0bps_trainpf_ge_1p3\D_EMA20_BOUNCE\candidates\final_candidate_needing_approval.json`

## Final Logic

- Entry logic: Long trend-continuation bounce when an uptrend stack retests EMA20 and closes back strong.
- Indicator values: `[['CCI', '<=', -70.127937]]`
- Non-indicator rules: `{'max_slot': '13:30'}`
- Pre-momentum filters: `[['pre2_mom_r', '>=', 0.010152], ['pre10_close_pos', '>=', 0.375]]`
- Filters and guards: `{'mask_terms': [['CCI', '<=', -70.127937]], 'entry_guards': {'max_slot': '13:30'}}`
- SL/target/exit: SL 1.2%, target 1.2%, 1-minute SL/target/EOD resolver.
