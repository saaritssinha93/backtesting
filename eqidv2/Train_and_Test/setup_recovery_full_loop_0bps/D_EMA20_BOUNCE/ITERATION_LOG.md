...
| 71 | stage5_seeded_random_combo | combination | n=385 PF=0.763 net=-38279.48 | n=272 PF=0.6027 net=-46918.59 | not run | not run | REJECT_FIT_VAL |
| 72 | stage5_seeded_random_combo | combination | n=102 PF=0.964 net=-1243.5 | n=82 PF=0.5476 net=-16101.83 | not run | not run | REJECT_FIT_VAL |
| 73 | stage5_seeded_random_combo | combination | n=62 PF=0.6792 net=-7450.27 | n=50 PF=0.6235 net=-5364.69 | not run | not run | REJECT_FIT_VAL |
| 74 | stage5_seeded_random_combo | combination | n=160 PF=0.7961 net=-13719.11 | n=81 PF=0.6293 net=-14461.1 | not run | not run | REJECT_FIT_VAL |
| 75 | stage5_seeded_random_combo | combination | n=130 PF=0.557 net=-22971.11 | n=111 PF=0.438 net=-25448.99 | not run | not run | REJECT_FIT_VAL |

Full CSV: `C:\Users\Saarit\OneDrive\Desktop\Trading\backtesting\eqidv2\backtesting\eqidv2\Train_and_Test\setup_recovery_full_loop_0bps\D_EMA20_BOUNCE\iteration_log.csv`
