r"""recreate_pool.py — recreate the B_HUGE_RED_FAILED_BOUNCE research pool for the
...
Output (same filename convention the tuner's load_pool() expects):
  pools/B_HUGE_RED_FAILED_BOUNCE/historical_all_available_pre_dedupe_live_candidates.csv
...
WORK = _HERE.parent                              # .../B_HUGE_RED_FAILED_BOUNCE
POOLS = WORK / "pools"
