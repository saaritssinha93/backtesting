# B_HUGE_RED_FAILED_BOUNCE (SHORT) — PARAMETER_INVENTORY
...
- **setup / side:** B_HUGE_RED_FAILED_BOUNCE / SHORT
...
- **pre-momentum rules (gate, ALL required, missing->block):** `[['pre3_close_pos', '<=', 0.581797], ['sig5_rsi_dir', '<=', 64.104659], ['pre5_mom_r', '<=', 0.284145]]`
