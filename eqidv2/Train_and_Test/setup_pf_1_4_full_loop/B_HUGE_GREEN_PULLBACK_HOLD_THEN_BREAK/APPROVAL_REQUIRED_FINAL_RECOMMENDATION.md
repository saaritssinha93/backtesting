# B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK (LONG) — APPROVAL_REQUIRED / FINAL RECOMMENDATION
...
py -3.12 Train_and_Test\setup_pf_1_4_full_loop\B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK\scripts\run_full_loop.py --trials 500 --time_budget_min 60 --seed 7
# reports
...
- TEST = 13 June/July sessions; June was a poor month for many of this book's setups — a single-month OOS is still one market regime.
