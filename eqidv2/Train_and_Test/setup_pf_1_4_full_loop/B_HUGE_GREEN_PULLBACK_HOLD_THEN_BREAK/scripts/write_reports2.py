r"""write_reports2.py — ROUND-2 report for B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK (enriched feature space).
Reads round2/run_summary.json; writes round2/ROUND2_RESULTS.md and, if any
candidate passed, candidates/B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK_candidate_r2_XXX.json + updates
