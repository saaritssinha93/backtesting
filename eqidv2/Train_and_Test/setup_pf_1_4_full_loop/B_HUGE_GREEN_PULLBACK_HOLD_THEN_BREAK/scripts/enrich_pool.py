...
onto the B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK recreated pool at the signal bar.

RESEARCH-ONLY. Reads pools/B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK/, writes pools/B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK_enriched/ (same
...
Run from repo root:
  py -3.12 Train_and_Test\setup_pf_1_4_full_loop\B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK\scripts\enrich_pool.py
"""
