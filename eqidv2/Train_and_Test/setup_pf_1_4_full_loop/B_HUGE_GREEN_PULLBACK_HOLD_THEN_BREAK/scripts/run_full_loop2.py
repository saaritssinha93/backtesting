r"""run_full_loop.py — B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK (LONG) full PF-band optimization loop — ROUND 2 (enriched features).
================================================================================
RESEARCH-ONLY. No live trades, no order placement, no final_setup_conf.py edits.
All artifacts stay under Train_and_Test/setup_pf_1_4_full_loop/B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK/.
...
Run from repo root:
  py -3.12 Train_and_Test\setup_pf_1_4_full_loop\B_HUGE_GREEN_PULLBACK_HOLD_THEN_BREAK\scripts\run_full_loop.py ^
