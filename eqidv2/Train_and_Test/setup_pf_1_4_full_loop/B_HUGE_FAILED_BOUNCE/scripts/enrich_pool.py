...
onto the B_HUGE_FAILED_BOUNCE recreated pool at the signal bar.

RESEARCH-ONLY. Reads pools/B_HUGE_FAILED_BOUNCE/, writes pools/B_HUGE_FAILED_BOUNCE_enriched/ (same
...
Run from repo root:
  py -3.12 Train_and_Test\setup_pf_1_4_full_loop\B_HUGE_FAILED_BOUNCE\scripts\enrich_pool.py
"""
