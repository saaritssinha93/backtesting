...
B_HUGE_C1_CLOSE_RECLAIM_BREAK from the artifacts produced by recreate_pool.py + run_full_loop.py.

RESEARCH-ONLY. Writes ONLY inside Train_and_Test/setup_pf_1_4_full_loop/B_HUGE_C1_CLOSE_RECLAIM_BREAK/.
...
Run from repo root:
  py -3.12 Train_and_Test\setup_pf_1_4_full_loop\B_HUGE_C1_CLOSE_RECLAIM_BREAK\scripts\write_reports.py
"""
