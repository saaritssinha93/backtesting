# -*- coding: utf-8 -*-
"""
avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.py - Live Trade Executor (Zerodha Real, V7_SWEEP)
========================================================================================
...
Output:
  - live_signals/live_trades_YYYY-MM-DD_v7_sweep.csv   (detailed trade log)
  - live_signals/live_trade_summary_v7_sweep.json       (running P&L summary)
...
Usage:
    python avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.py
    python avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.py --max-trades 10
    python avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.py --dry-run  # validate without trading
"""
...
EXECUTED_SIGNALS_FILE = os.path.join(SIGNAL_DIR, "executed_signals_live_v7_sweep.json")
MIS_REJECTED_SYMBOLS_FILE = os.path.join(SIGNAL_DIR, "mis_rejected_symbols_v7_sweep.json")
SUMMARY_FILE = os.path.join(SIGNAL_DIR, "live_trade_summary_v7_sweep.json")
OPEN_TRADES_STATE_PATTERN = "open_live_trades_state_{}_v7_sweep.json"
KILL_SWITCH_COMMAND_FILE = os.path.join(SIGNAL_DIR, "kill_switch_false_v7_sweep.json")
