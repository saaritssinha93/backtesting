...
from avwap_v11_refactored.avwap_short_strategy_v6_sweep import (
    scan_all_days_for_ticker as scan_short,
)
from avwap_v11_refactored.avwap_long_strategy_v6_sweep import (
...
PACK2_SHORT_MAX_VIX_FOR_ENTRIES = 13.5
ENABLE_DAY_LOSS_GUARD = True
    ...
    with open(log_path, "w", encoding="utf-8") as _log_fh:
        ...
        try:
            ...
            if VIX_SCALE_ENABLED and _vix_map:
                ...
                print("[VIX] Scaling DISABLED â€” fixed SL/target used (old behaviour).")
