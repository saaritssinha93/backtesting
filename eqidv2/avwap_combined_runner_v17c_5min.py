# -*- coding: utf-8 -*-
"""
avwap_combined_runner_v17c_5min.py - AVWAP v17c COMBINED runner on 5-minute signals
====================================================================================
...
1. All outputs saved to outputs_v17c_5min/
...
V17C_SHORT_SIGNAL_AVWAP_DIST_ATR_MAX = _env_float("EQIDV17C_SHORT_SIGNAL_AVWAP_DIST_ATR_MAX", 2.10)
...
def main() -> None:
    ...
    _outputs_dir = runtime_dir("outputs_v17c_5min")
    ...
    with open(log_path, "w", encoding="utf-8") as _log_fh:
        ...
        try:
            ...
            print("=" * 70)
            print("AVWAP v17c_5min COMBINED runner — v17c longs + v17b shorts + no BE exits")
            ...
            # --- Save CSV ---
            out_csv = _outputs_dir / f"avwap_longshort_trades_v17c_5min_ALL_DAYS_{ts}.csv"
            combined.to_csv(out_csv, index=False)
            out_daywise_csv = _outputs_dir / f"avwap_daywise_breakdown_v17c_5min_ALL_DAYS_{ts}.csv"
