...
def _apply_v7_sweep_short_overrides() -> None:
    ...
    v2.REPORTS_DIR = ROOT / "reports" / "eqidv2_reports_v7_sweep_short"
    v2.REPORTS_DIR.mkdir(parents=True, exist_ok=True)

    v2.OUT_CHECKS_DIR = ROOT / "out_eqidv2_live_checks_15m_v7_sweep_short"
    v2.OUT_SIGNALS_DIR = ROOT / "out_eqidv2_live_signals_15m_v7_sweep_short"
