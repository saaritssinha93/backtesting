"""
final_setup_conf_v12_base.py — isolated V12 research baseline setup book.
===========================================================================
...
# Keep the frozen prefilter-dependent setup identical to the V7 gate of record.
# deepcopy prevents V12's relaxation bookkeeping from mutating the live book.
from copy import deepcopy as _deepcopy
from final_setup_conf import FINAL_SETUP_CONF as _V7_FINAL_SETUP_CONF

FINAL_SETUP_CONF["QUIET_LIQUID_ONE_BAR_DEFER_LONG"] = _deepcopy(
    _V7_FINAL_SETUP_CONF["QUIET_LIQUID_ONE_BAR_DEFER_LONG"]
)
