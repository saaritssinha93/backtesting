...
if "%LOG_DASH_SMTP_USER%"=="" set "LOG_DASH_SMTP_USER=%LOG_DASH_EMAIL_FROM%"
if "%LOG_DASH_EMAIL_SEND_MODE%"=="" set "LOG_DASH_EMAIL_SEND_MODE=gmail_api_then_smtp"
...
if "%LOG_DASH_GMAIL_INTERACTIVE_AUTH%"=="" set "LOG_DASH_GMAIL_INTERACTIVE_AUTH=1"
