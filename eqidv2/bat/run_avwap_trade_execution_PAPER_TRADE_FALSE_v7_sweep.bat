...
set "SCRIPT_NAME=avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.py"
set "MAX_TRADES=0"
set "STATUS_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.status"
set "HEARTBEAT_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep.heartbeat"
...
set "LOG_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_FALSE_v7_sweep_%TODAY_IST%.log"
