...
set "SCRIPT_NAME=eqidv2_signal_engine_v16_5min.py"
set "STATUS_FILE=%LOG_DIR%\eqidv2_signal_engine_v16_5min.status"
set "HEARTBEAT_FILE=%LOG_DIR%\eqidv2_signal_engine_v16_5min.heartbeat"
set "WORKER_STATUS_FILE=%RUNTIME_STATUS_DIR%\eqidv2_signal_engine_v16_5min.status"
set "WORKER_HEARTBEAT_FILE=%RUNTIME_STATUS_DIR%\eqidv2_signal_engine_v16_5min.heartbeat"
set "LOCK_FILE=%RUNTIME_STATUS_DIR%\eqidv2_signal_engine_v16_5min.supervisor.lock"
set "SPAWN_RECORD_FILE=%RUNTIME_STATUS_DIR%\eqidv2_signal_engine_v16_5min.supervisor.spawn"
...
set "LOG_FILE=%LOG_DIR%\eqidv2_signal_engine_v16_5min_%TODAY_IST%.log"
