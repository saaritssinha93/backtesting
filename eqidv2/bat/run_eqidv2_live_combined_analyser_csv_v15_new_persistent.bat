...
set "STATUS_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_new_persistent.status"
set "HEARTBEAT_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_new_persistent.heartbeat"
