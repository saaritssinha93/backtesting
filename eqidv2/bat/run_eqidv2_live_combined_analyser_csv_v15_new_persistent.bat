...
set "EQIDV2_POST_READY_STAGGER_SECONDS=0"
...
set "EQIDV2_SLOT_READY_MIN_FRESH_RATIO=0.70"
set "EQIDV2_SLOT_READY_MARKER_MIN_RATIO=0.70"
...
set "SCRIPT_NAME=eqidv2_live_combined_analyser_csv_v15_new_persistent.py"
set "LOG_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_new_persistent.log"
set "ALERT_LOG=%ALERT_DIR%\CRITICAL_eqidv2_live_combined_analyser_csv_v15_new_persistent.log"
set "STATUS_FILE=%RUNTIME_STATUS_DIR%\eqidv2_live_combined_analyser_csv_v15_new_persistent.status"
set "HEARTBEAT_FILE=%RUNTIME_STATUS_DIR%\eqidv2_live_combined_analyser_csv_v15_new_persistent.heartbeat"
...
echo [INFO] V15_NEW tuning: snapshot_workers=!EQIDV15_NEW_SNAPSHOT_MAX_WORKERS!, scan_workers=!EQIDV15_NEW_SCAN_MAX_WORKERS!, rolling_cache=!EQIDV15_NEW_USE_ROLLING_CACHE!, incremental_rows=!EQIDV15_NEW_INCREMENTAL_REFRESH_ROWS!, ready_marker=!EQIDV2_SLOT_READY_MARKER_ENABLED!, ready_poll=!EQIDV2_SLOT_READY_POLL_ENABLED!, ready_max_wait=!EQIDV2_SLOT_READY_MAX_WAIT_SECONDS!s, ready_poll_s=!EQIDV2_SLOT_READY_POLL_SECONDS!s, ready_sample=!EQIDV2_SLOT_READY_SAMPLE_SIZE!, ready_ratio=!EQIDV2_SLOT_READY_MIN_FRESH_RATIO!>>"%LOG_FILE%"
for /f %%a in ('powershell -NoProfile -Command "Get-Date -Format yyyy-MM-dd_HH:mm:ss"') do set "RUN_TS=%%a"
