...
echo [INFO] NIFTY guard fetch loop: symbol=%NIFTY_SYMBOL%, aliases=%NIFTY_ALIASES%, slot_minutes=00/15/30/45, first_slot=%FIRST_SLOT_HHMM%, cutoff=%END_CUTOFF_HHMM%, poll=%POLL_SEC%s>>"%LOG_FILE%"
