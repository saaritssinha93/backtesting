...
set "EQIDV16_5MIN_SHORT_STOP_PCT=0.0078"
set "EQIDV16_5MIN_LONG_STOP_PCT=0.0060"
set "EQIDV16_5MIN_SHORT_TARGET_PCT=0.0070"
set "EQIDV16_5MIN_LONG_TARGET_PCT=0.00825"
