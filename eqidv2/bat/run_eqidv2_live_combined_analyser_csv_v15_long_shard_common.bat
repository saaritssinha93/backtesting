...
set "EQIDV15_LONG_SHARD_SCAN_MAX_WORKERS=4"
...
set "STATUS_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_long_shard_%SHARD_ID%.status"
set "HEARTBEAT_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_long_shard_%SHARD_ID%.heartbeat"
