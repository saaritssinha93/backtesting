...
set "PAPER_BAT=%BAT_DIR%\run_avwap_trade_execution_PAPER_TRADE_TRUE_v5.bat"

set "TASK_LIVE_SHORT=EQIDV2_live_combined_csv_v5_short_0900"
set "TASK_LIVE_LONG=EQIDV2_live_combined_csv_v5_long_0900"
set "TASK_PAPER=EQIDV2_avwap_paper_trade_v5_0900"
...
echo [INFO] Creating weekday V5 unified papertrade task at 09:00 ...
