...
set "EQIDV15_SHORT_STOP_PCT=0.0075"
set "EQIDV15_LONG_STOP_PCT=0.0075"
set "EQIDV15_SHORT_TARGET_PCT=0.0095"
set "EQIDV15_LONG_TARGET_PCT=0.0095"
set "LOG_DIR=%BASE_DIR%\logs"
set "SCRIPT_NAME=avwap_trade_execution_PAPER_TRADE_TRUE_v15.py"
set "MAX_TRADES=0"
...
echo [INFO] Target policy: short_target_pct=%EQIDV15_SHORT_TARGET_PCT%, long_target_pct=%EQIDV15_LONG_TARGET_PCT%
echo [INFO] Target policy: short_target_pct=%EQIDV15_SHORT_TARGET_PCT%, long_target_pct=%EQIDV15_LONG_TARGET_PCT%>>"%LOG_FILE%"
