...
set "PAPER_BAT=%BAT_DIR%\run_avwap_trade_execution_PAPER_TRADE_TRUE_v7_sweep.bat"
...
set "TASK_PAPER=EQIDV2_avwap_paper_trade_v7_sweep_0900"
...
echo [INFO] Creating weekday V7 Sweep unified papertrade task at 09:00 ...
