...
rem EQIDV7_ID_5MIN_FORCE_ENTRY_QUANTITY removed: executor uses signal CSV qty.
set "EQIDV2_LATE_DETECTION_MAX_LAG_SEC=30"
set "EQIDV2_MAX_CONCURRENT_TRADES=20"
set "EQIDV2_MAX_OPEN_POSITIONS=20"
rem EQIDV2_CONFIG_CHECK_BYPASS removed: config mismatch must stop live startup.
