...
echo [INFO] Live slim store: data=%EQIDV2_DATA_5M_DIR% cache=%EQIDV2_CACHE_5MIN_DIR% slim_mode=%EQIDV2_5M_LIVE_SLIM_MODE% keep_days=%EQIDV2_5M_LIVE_SLIM_CALENDAR_DAYS%>>"%LOG_FILE%"
