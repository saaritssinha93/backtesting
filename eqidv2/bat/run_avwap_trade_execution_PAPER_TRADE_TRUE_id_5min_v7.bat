...
set "EQIDV2_PAPER_V7_ENTRY_LAG_MIN=5"
...
set "EQIDV2_MAX_CONCURRENT_TRADES=100"
set "EQIDV2_MAX_OPEN_POSITIONS=100"
set "EQIDV2_MAX_CAPITAL_DEPLOYED_RS=2000000"
set "EQIDV2_PAPER_V7_ID_5MIN_MAX_CONCURRENT_TRADES=100"
set "EQIDV2_PAPER_V7_ID_5MIN_MAX_OPEN_POSITIONS=100"
...
set "EQIDV2_PAPER_V7_DAILY_LOSS_BRAKE_ENABLED=0"
set "EQIDV2_PAPER_V7_DAILY_LOSS_BRAKE_RS=7500"
