...
set "STATUS_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v7_sweep_short.status"
set "HEARTBEAT_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v7_sweep_short.heartbeat"
