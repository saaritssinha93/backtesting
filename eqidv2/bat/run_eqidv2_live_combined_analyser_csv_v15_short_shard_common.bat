...
set "STATUS_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_short_shard_%SHARD_ID%.status"
set "HEARTBEAT_FILE=%LOG_DIR%\eqidv2_live_combined_analyser_csv_v15_short_shard_%SHARD_ID%.heartbeat"
