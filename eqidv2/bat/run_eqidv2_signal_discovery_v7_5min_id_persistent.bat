...
REM SHORT_FOCUS disabled: both LONG and SHORT setups are allowed.
REM Previously SHORT_FOCUS=1 with ALLOWED_SIDES=SHORT (only A_MOD_BREAK_C1_HIGH,C_OR_BREAKOUT were LONG-exempt).
