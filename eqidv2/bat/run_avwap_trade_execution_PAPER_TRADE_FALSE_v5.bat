...
set "EQIDV5_SHORT_TARGET_PCT=0.008"
set "EQIDV5_LONG_TARGET_PCT=0.009"
set "LOG_DIR=%BASE_DIR%\logs"
set "SCRIPT_NAME=avwap_trade_execution_PAPER_TRADE_FALSE_v5.py"
set "MAX_TRADES=0"
set "STATUS_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_FALSE_v5.status"
set "HEARTBEAT_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_FALSE_v5.heartbeat"
...
set "LOG_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_FALSE_v5_%TODAY_IST%.log"
