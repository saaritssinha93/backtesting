...
set "SCRIPT_NAME=avwap_trade_execution_PAPER_TRADE_TRUE_v7_sweep.py"
set "MAX_TRADES=0"
...
set "LOG_FILE=%LOG_DIR%\avwap_trade_execution_PAPER_TRADE_TRUE_v7_sweep_%TODAY_IST%.log"
...
echo [INFO] Target policy: short_target_pct=%EQIDV7_SWEEP_SHORT_TARGET_PCT%, long_target_pct=%EQIDV7_SWEEP_LONG_TARGET_PCT%
echo [INFO] Target policy: short_target_pct=%EQIDV7_SWEEP_SHORT_TARGET_PCT%, long_target_pct=%EQIDV7_SWEEP_LONG_TARGET_PCT%>>"%LOG_FILE%"
