# -*- coding: utf-8 -*-
"""
avwap_combined_runner_v18b_5min.py - AVWAP v18b COMBINED runner on 5-minute signals
===================================================================================
...
1. All outputs saved to outputs_v18b_5min/
...
def main() -> None:
    ...
    _outputs_dir = runtime_dir("outputs_v18b_5min")
    _outputs_dir.mkdir(parents=True, exist_ok=True)

    ts = now_ist().strftime("%Y%m%d_%H%M%S")
    log_path = _outputs_dir / f"avwap_combined_runner_v18b_{ts}.txt"
    ...
    with open(log_path, "w", encoding="utf-8") as _log_fh:
        ...
        try:
            ...
            print("=" * 70)
            print("AVWAP v18b_5min COMBINED runner — staged shortlist expansion + tier-aware filters")
            ...
            if ENABLE_PLAYBOOK_V11_PROFILE:
                ...
                print("[PROFILE] V18b: staged short expansion + rank-aware shortlist rescue on fast prebuilt history.")
            ...
            print("\n[V18b] Applying session-wise historical shortlist universe...")
            ...
            # --- Save CSV ---
            out_csv = _outputs_dir / f"avwap_longshort_trades_v18b_5min_ALL_DAYS_{ts}.csv"
            combined.to_csv(out_csv, index=False)
            out_daywise_csv = _outputs_dir / f"avwap_daywise_breakdown_v18b_5min_ALL_DAYS_{ts}.csv"
