...
Usage:
    python avwap_trade_execution_PAPER_TRADE_TRUE_v4_short.py
    python avwap_trade_execution_PAPER_TRADE_TRUE_v4_short.py --no-ltp
    python avwap_trade_execution_PAPER_TRADE_TRUE_v4_short.py --capital 500000
"""
...
SIGNAL_CSV_PATTERN = "signals_{}_v4_short.csv"
PAPER_TRADE_LOG_PATTERN = "paper_trades_{}_v4_short.csv"
PAPER_TRADE_EXEC_LOG_PATTERN = "paper_trade_execution_{}_v4_short.log"
EXECUTED_SIGNALS_FILE = os.path.join(SIGNAL_DIR, "executed_signals_paper_v4_short.json")
SUMMARY_FILE = os.path.join(SIGNAL_DIR, "paper_trade_summary_v4_short.json")
OPEN_TRADES_STATE_PATTERN = "open_trades_state_{}_v4_short.json"
ALLOWED_SIGNAL_SIDES = {"SHORT"}
