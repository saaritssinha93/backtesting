...
from avwap_v11_refactored.avwap_long_strategy_v11_newlong import (
...
def main() -> None:
    ...
    _outputs_dir = _project_root / (
        "outputs_v11_newlong_target_test" if TEST_TARGET_OVERRIDE else "outputs_v11_newlong"
    )
    ...
    with open(log_path, "w", encoding="utf-8") as _log_fh:
        ...
        try:
            print("=" * 70)
            print("AVWAP v11 COMBINED runner - LONG + SHORT (playbook_v11_newlong)")
            ...
            if ENABLE_PLAYBOOK_V11_PROFILE:
                ...
                print("[PROFILE] playbook_v11_newlong tuned profile enabled (long DD-reduction variant).")
