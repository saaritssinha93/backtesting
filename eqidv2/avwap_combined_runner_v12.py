# -*- coding: utf-8 -*-
"""
avwap_combined_runner_v12.py - AVWAP v12 COMBINED runner: V11 SHORT + V9 LONG (hybrid)
==================================================================================
...
def main() -> None:
    ...
    _outputs_dir = _project_root / "outputs_v12"
    ...
    with open(log_path, "w", encoding="utf-8") as _log_fh:
        ...
        try:
            print("=" * 70)
            print("AVWAP v12 COMBINED runner — V11 SHORT + V9 LONG (hybrid)")
            ...
            if ENABLE_PLAYBOOK_V11_PROFILE:
                ...
                print("[PROFILE] V12: playbook_v11 SHORT + V9 s5 LONG with close-confirm gate.")
            ...
            # --- Save CSV ---
            out_csv = _outputs_dir / f"avwap_longshort_trades_v12_ALL_DAYS_{ts}.csv"
