...
# Resolve to current strategy folder so this tester is portable across machines.
root = Path(__file__).resolve().parent
live_file = root / "eqidv3_live_combined_analyser_csv.py"
replay_csv = root / "out_eqidv3_live_signals_15m" / f"replay_signals_{date_str}.csv"
